...
.stApp {
  background:
    radial-gradient(circle at 15% 0%, rgba(239,29,36,.18), transparent 30%),
    radial-gradient(circle at 90% 10%, rgba(215,220,226,.09), transparent 25%),
    linear-gradient(135deg, #050608 0%, #090d12 48%, #030405 100%);
  color:#f6f8fb;
}
[data-testid="stSidebar"] {
  background: linear-gradient(180deg, rgba(3,5,7,.98) 0%, rgba(11,15,21,.98) 100%);
  border-right:1px solid rgba(215,220,226,.16);
  box-shadow: 8px 0 35px rgba(0,0,0,.35);
}
.block-container { padding-top:1.15rem; padding-bottom:2rem; }
.aks-logo-wrap {
  border-bottom:1px solid rgba(215,220,226,.18);
  margin-bottom:16px;
  padding: 10px 8px 18px 8px;
}
.aks-logo-real { filter: drop-shadow(0 10px 22px rgba(0,0,0,.45)); }
.title {
  font-size:38px;
  line-height:1.05;
  font-weight:950;
...
.subtitle { color:var(--aks-muted); margin-top:4px; font-size:16px; }
.aks-card {
  background: linear-gradient(145deg, rgba(18,25,35,.96), rgba(8,12,17,.97));
  border:1px solid rgba(215,220,226,.16);
  border-radius:20px;
  padding:20px;
  box-shadow: 0 20px 55px rgba(0,0,0,.30), inset 0 1px 0 rgba(255,255,255,.03);
}
.metric-card {
  background: linear-gradient(145deg, rgba(22,30,41,.98), rgba(9,14,20,.98));
...
.metric-card:before {
  ...
  height:3px;
  background:linear-gradient(90deg, var(--aks-red), #f4f4f4, var(--aks-red));
  opacity:.85;
}
.metric-label {
  color:#cfd6de;
...
.metric-value { color:#fff; font-size:30px; font-weight:950; margin-top:7px; }
.metric-help { color:var(--aks-muted); font-size:13px; margin-top:6px; }
.warn { color:var(--aks-amber) !important; }
.danger { color:#ff4747 !important; }
.good { color:var(--aks-green) !important; }
.contact-box {
  border:1px solid rgba(215,220,226,.18);
  border-radius:16px;
  padding:16px;
  background:linear-gradient(145deg,#080d13,#0d141c);
  margin-top:16px;
  font-size:14px;
  box-shadow: inset 0 1px 0 rgba(255,255,255,.03);
}
.contact-title { color:var(--aks-red); font-weight:950; margin-bottom:8px; letter-spacing:.4px; }
.staff-pill {
  background:linear-gradient(145deg,#0d141c,#080c11);
  border:1px solid rgba(215,220,226,.20);
  border-radius:999px;
  padding:9px 14px;
  color:#dbe2ea;
  font-size:13px;
...
.stButton>button {
  background: linear-gradient(180deg, #ff3037, #b71117);
  color:white;
  border:1px solid rgba(255,255,255,.18);
  border-radius:12px;
  font-weight:900;
  box-shadow:0 10px 24px rgba(239,29,36,.22);
}
.stButton>button:hover { background: linear-gradient(180deg, #ff4248, #cb151b); border-color:#ffffff; color:white; }
div[data-testid="stLinkButton"] a { border-radius:12px; font-weight:900; }
.key-card {
  border:1px solid rgba(215,220,226,.16);
  background:linear-gradient(145deg,#0c1219,#070b10);
  border-radius:18px;
  padding:14px;
  height:100%;
  box-shadow:0 14px 34px rgba(0,0,0,.25);
}
.key-title { font-weight:950; font-size:18px; color:#fff; margin-top:10px; }
.key-meta { color:#b7c1cc; font-size:13px; margin-top:4px; }
.price { color:#ffffff; font-size:23px; font-weight:950; margin-top:8px; }
.website-card {
...
.website-card h3 { color:#0e1115; margin-top:0; }
.login-hero {
  max-width: 660px;
  margin: 32px auto 0 auto;
  background: radial-gradient(circle at 50% 0%, rgba(239,29,36,.18), transparent 38%),
              linear-gradient(145deg, rgba(18,25,35,.98), rgba(5,7,10,.98));
  border:1px solid rgba(215,220,226,.22);
  border-radius:30px;
...
hr { border-color: rgba(215,220,226,.16); }
.public-hero {
  max-width:1120px;
  margin: 6px auto 24px auto;
  background: radial-gradient(circle at 20% 0%, rgba(239,29,36,.22), transparent 32%),
              linear-gradient(145deg, rgba(17,24,34,.98), rgba(5,7,10,.98));
  border:1px solid rgba(215,220,226,.20);
  border-radius:28px;
  padding:32px;
...
def login_screen():
    ...
    <div class="login-hero">
      <div class="login-logo aks-logo-real">
        {aks_logo_html(430)}
...
if PUBLIC_MODE:
    ...
    <div class="public-hero">
      ...
      <div style="text-align:center;color:#c8d0d8;font-size:17px;">
